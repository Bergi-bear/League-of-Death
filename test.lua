...
module.Vector3D = function(ix, iy, iz)
	...
	function v3d:deepcopy(orig)
		--Deeply copy a table. This is for the operation metatables.
	...
	function v3d:getAngle()
		--Return the 3D angle (heading, carom) of the vector IN RADIANS!.
	...
	function v3d:getLength()
		--Return the length of the vector (i.e. the distance from (0,0), see README.md for examples of using this)
